...
import { Clock, BarChart3, TrendingUp, Zap, Calendar, ArrowUpRight, PieChart, Lock } from 'lucide-react';
...
export const DashboardPage = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* 1. Professional Analytics Mockup (High Visibility + Blur) */}
      <div className="relative overflow-hidden rounded-3xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm h-[420px] group">
        ...
        {/* Removed opacity-50 to make colors pop, reduced blur to 1px */}
        <div className="filter blur-[1.5px] pointer-events-none select-none p-8 space-y-8 h-full transition-all duration-500 group-hover:blur-[3px]">
           ...
           <div className="grid grid-cols-3 gap-6 h-64">
              {/* Main Bar Chart Mock - Vibrant Colors */}
        ...
        {/* --- The Overlay Layer (Glassmorphism) --- */}
        {/* Adjusted background opacity for Light Mode visibility */}
      ...
      {/* 2. Active Real Stats (Focus Time) */}
